...
from semantics_transformers import __version__
...
class SemanticsTransformer(nn.Sequential):
    def __init__(self, model_path: str = None, modules: List = None, device: str = None):
