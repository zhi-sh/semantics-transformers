...
from semantics_transformers.tools import utils, tools
from semantics_transformers.models import AbstractModel
from semantics_transformers.models.tokenizer import AbstractTokenizer, WhitespaceTokenizer
...
class WordEmbeddings(nn.Module, AbstractModel):
    ...
    @staticmethod
    def from_file(raw_text_file: str, w2v_file_path: str = None, max_vocab_size: int = 100000, update_embeddings: bool = False, w2v_separator: str = ' ', tokenizer=WhitespaceTokenizer()):
        r'''
